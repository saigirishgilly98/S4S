...
public class AdminActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabpagerAdapter Tabpageradapter = new tabpagerAdapter(getSupportFragmentManager(), AdminActivity.this);
        ...
        searchbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(AdminActivity.this, SearchResults.class);
                startActivity(i);
            }
        });
        ...
        FirebaseDatabase.getInstance().getReference().child("User").child(FirebaseAuth.getInstance().getUid()).child("url").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                Picasso.with(AdminActivity.this).load(url).fit().centerCrop().into(imageView);
            }
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (imageurl != " ")
                    Picasso.with(AdminActivity.this).load(imageurl).fit().centerCrop().into(imageView);
    ...
    public void openProfileEdit1(View view) {
        Intent i = new Intent(this, ProfileEditAdmin.class);
        startActivity(i);
    }
